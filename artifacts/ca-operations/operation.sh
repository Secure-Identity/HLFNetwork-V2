...
EnrollAdmin() {
    ...
    fabric-ca-client enroll -u https://admin:adminpw@localhost:7054 --caname ca.org1.secretidentity.com --tls.certfiles ${PWD}/fabric-ca/tls-cert.pem
...
EnrollPeer() {
    ...
    fabric-ca-client enroll \
        ...
        --csr.hosts peer0.org1.secretidentity.com \
        --tls.certfiles ${PWD}/fabric-ca/tls-cert.pem
}
